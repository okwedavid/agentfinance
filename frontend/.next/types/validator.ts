...
// Validate ../../src/app/dashboard/coord/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dashboard/coord">> = Specific
  const handler = {} as typeof import("../../src/app/dashboard/coord/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/proxy/tasks/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/proxy/tasks">> = Specific
  const handler = {} as typeof import("../../src/app/api/proxy/tasks/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
